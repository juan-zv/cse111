def main():
    ...
    molecules_in_formula = parse_formula(chemical_formula, periodic_table_dict)

    molar_mass = compute_molar_mass(molecules_in_formula, periodic_table_dict)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for _ in symbol_quantity_list:
        # Separate the inner list into symbol and quantity.
            symbol = symbol_quantity_list[NAME_INDEX][0]
            quantity = symbol_quantity_list[NAME_INDEX][1]

        # Get the atomic mass for the symbol from the dictionary.
            atomic_mass = periodic_table_dict[symbol]

        # Multiply the atomic mass by the quantity.
            molar_mass = atomic_mass[1] * float(quantity)
